 ...
 * @property {string} type - Type of fragment - i.e. a submodule/group/file or 
 *      a method contained within a submodule file
 * @property {string} hierarchy - Relative path relation to current selected
 *      submodule (i.e. child, sibling, parent etc.), used to determine how 
 *      this submodule should be rendered (hidden, nested right etc.)
