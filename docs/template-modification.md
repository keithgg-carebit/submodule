...
Template modification scripts are bundled from an entry point at `src/web/scripts/<template-name>/index.js`, and imported shared scripts which provide methods for rendering from a data object generated by the template specific scripts. The target bundle file for a given template will be at `dist/submodule-<template-name>.min.js` or browse [dist directory here](https://github.com/blameitonyourisp/submodule/tree/master/dist) on github. For the shared scripts, see `src/web/scripts/shared` or browse [shared scripts](https://github.com/blameitonyourisp/submodule/tree/master/src/web/scripts/shared) on github. For template specific scripts, please see `src/web/scripts/<template-name>/index.js` or browse the [scripts directory](https://github.com/blameitonyourisp/submodule/tree/master/src/web/scripts) on github for entry points for each specific 3rd party template.
...
```json
{
    "templates": {
        "default": {
            "staticFiles": {
                "include": [
                    "node_modules/@13ms/submodule/dist/submodule-<template-name>.min.js",
                    "node_modules/@13ms/submodule/dist/submodule-<template-name>.min.js.map"
                ]
            }
        }
    }
...
| ------------------ | ------------------------------------------------------------ | ---------------------------- | ------------------ | ------------------------------------------------------------ |
| `folder-open`      | [open folder asset link](https://www.svgrepo.com/svg/450896/folder-open) | `module`, `namespace-module` | n/a                | <img src="../assets/folder-open.svg" alt="file-code" onerror="this.src='folder-open.svg'" /> |
| `folder-closed`    | [closed folder asset link](https://www.svgrepo.com/svg/450891/folder) | n/a                          | `module`           | <img src="../assets/folder-closed.svg" alt="file-code" onerror="this.src='folder-closed.svg'" /> |
| `folder-namespace` | [namespace folder asset link](https://www.svgrepo.com/svg/450894/folder-move) | n/a                          | `namespace-module` | <img src="../assets/folder-namespace.svg" alt="file-code" onerror="this.src='folder-namespace.svg'" /> |
| `file`             | [file asset link](https://www.svgrepo.com/svg/450862/file-code) | `file`                       | `file`             | <img src="../assets/file-code.svg" alt="file-code" onerror="this.src='file-code.svg'" /> |
